...
Write-Host "   https://login.microsoftonline.com/$tenantId/adminconsent?client_id=$applicationId&redirect_uri=https%3A%2F%2Flogin.microsoftonline.com%2Fcommon%2Foauth2%2Fnativeclient"
Write-Host ""
